...
However, there was a tibble formed in `checking_conflicts_right` indicating row mismatches. Upon examinging the tibble, there were 3 albums: "Fearless", "Red" and "The Taylor Swift Holiday Collection", which were found in `taylor_all_songs` but not `taylor_album_songs`.
