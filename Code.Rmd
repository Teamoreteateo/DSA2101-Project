...
ggplot(taylor_long %>% filter(labels != "tempo"), aes(y = labels, x = values, fill = labels)) +
  ...
  theme(
    ...
    plot.title = element_text(size = 16, hjust = -30, face = "bold"), 
    plot.subtitle = element_text(size = 16, hjust= -0.4, face = "bold"),
    aspect.ratio = 0.9,
...
Overall, there seems to be a noted shift towards rhythmic and punchy songs that are sad and acoustically driven. We think that her audience received this shift well because they were yearning for something different from the usual mainstream pop soundscape of the early 2000s and mid 2010s which is characterised by Electronic Dance music and piercing Disco pop sounds (Savage, 2020).
