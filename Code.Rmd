...
```{r}
plotting = taylor_album_summary %>% pivot_longer(cols =c(mean_acousticness, mean_instrumentalness, mean_valence), names_to="variable", values_to="value")
...
Acousticness increased, songs involved lesser electronic sounds and sounded more raw.