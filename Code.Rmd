...
#### Methodology
This visualisation focuses on the distribution of musical feature values for Taylor Swift's songs using an overlayed violin and box plot. 
...
The violin plot also allows us to notice any multi-modal distributions within the data, which may indicate polarisation of songs within a feature. 
