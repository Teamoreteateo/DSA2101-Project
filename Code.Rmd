...
```{r}
=======
>>>>>>> 7b7fc0971f994643abd2687356af0cb14991d6df
...
taylor_album_songs <- taylor_album_songs %>%
    select(album_name, album_release, track_name, loudness, mode, speechiness, acousticness, instrumentalness, valence, tempo)
