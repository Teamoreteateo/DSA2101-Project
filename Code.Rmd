...
*Disclaimer: Track Numbers reflected in the table and plot do not correspond to actual track numbers. They have been mapped to the track names according to the order seen in the plot for ease of reading.*
```{r proportion-plot}
...
songname_tracknumber_table = cbind(most_popular_album_songs$track_number,most_popular_album_songs$track_name)
