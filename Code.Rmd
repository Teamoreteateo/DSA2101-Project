...
Despite the wide range of `variance` values observed across Swift's songs in Plot 1, we observed that `valence` strength appears rather stable across albums in this plot. 
